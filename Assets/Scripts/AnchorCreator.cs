...
namespace UnityEngine.XR.ARFoundation.Samples
{
    ...
    public class AnchorCreator : MonoBehaviour
    {
        ...
        {
            ARDebugManager.Instance.LogInfo($"Removing all anchors ({m_Anchors.Count})");
        ...
        ARAnchor CreateAnchor(in ARRaycastHit hit)
        {
            ...
            if (hit.trackable is ARPlane plane)
            {
                ...
                if (planeManager)
                {
                    ...
                    UnityEngine.Debug.Log($"Anchor {anchor.trackableId}:  Attached to plane {plane.trackableId}");
                    return anchor;
                }
            }
            ...
            UnityEngine.Debug.Log($"Anchor {anchor.trackableId}: Anchor (from {hit.hitType})");
